...
# Per-sample (per-SRR) peak calling for kidney sample-level QC.
# Usage: python peak_calling.py <SRR_ID>
srr = sys.argv[1]
out_dir = f"/QRISdata/Q8448/Mouse_disease_data/Kidney/peaks/{srr}"
