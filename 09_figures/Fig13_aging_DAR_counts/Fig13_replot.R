...
fig14 <- (make_panel(plot_df, "Kidney", "A  Kidney") /
...
ggsave(file.path(AGING_DIR, "Fig13_aging_DAR_counts.pdf"), fig14, width = 10, height = 9)
ggsave(file.path(AGING_DIR, "Fig13_aging_DAR_counts.png"), fig14, width = 10, height = 9, dpi = 300)
