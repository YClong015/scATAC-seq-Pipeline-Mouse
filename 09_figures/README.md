...
| Fig 18 (aging DAR counts) | (in `08_aging_comparison/replots/Fig13_replot.R`) | renamed Fig 18 in thesis |
| Fig 19 (Aim 3 OR + r summary) | `08_aging_comparison/03_overlap/03_overlap_and_plots.sh` → `Aim3_DAR_overlap_summary.{pdf,png}` | |
| Fig 20 (disease vs aging scatter) | `08_aging_comparison/03_overlap/03_overlap_and_plots.sh` → `DAR_scatter_combined.{pdf,png}` | |
| Fig 21 (region classification) | `08_aging_comparison/04_region_classification.sh` → `region_stacked_counts.{pdf,png}` etc. | |
...
bash    09_figures/Fig3_4_QC/QC_plots.sh

# Fig 5 / 6 — universal peak set composition + UpSet
Rscript 09_figures/Fig5_6_universal_peaks/Fig4_universal_peaks_v2.R

# Fig 7 — per-tissue UMAPs and integrated UMAP
Rscript 09_figures/Fig7_UMAP/Fig5_UMAP_annotation.R
Rscript 09_figures/Fig7_UMAP/Fig5_Tcells_annotation.R
Rscript 09_figures/Fig7_UMAP/Fig_integration_UMAP.R

# Fig 8 — Coverage plots at marker genes
Rscript 09_figures/Fig8_CoveragePlot/link_fragments_and_save.R    # one-time prep
Rscript 09_figures/Fig8_CoveragePlot/Fig_CoveragePlot.R

# Fig 9 — DAR counts diverging tile
Rscript 09_figures/Fig9_DAR_counts/Fig9_DAR_counts.R

# Fig 10 — integrated 4-tissue HOMER heatmap
Rscript 09_figures/Fig10_HOMER_heatmap/4tissues_integrate_heatmap.R
Rscript 09_figures/Fig10_HOMER_heatmap/assemble_Fig7.R            # compose NS + Stable panels

# Fig 11 — cell-type identity TF baseline (CM-paper style or v6-filtered barplot)
sbatch  09_figures/Fig11_identity_TF/cell_identity_heatmap.sh
Rscript 09_figures/Fig11_identity_TF/cell_identity_barplot.R
Rscript 09_figures/Fig11_identity_TF/assemble_Fig6.R              # compose 6 cell-identity panels

# Fig 12 + 17 + Supp Fig 7 — shared / specific / all-tissues TF motif dotplots
Rscript 09_figures/Fig12_17_TF_motif_dotplots/Fig10_11_16_dotplots.R
sbatch  09_figures/Fig12_17_TF_motif_dotplots/run_TF_motif_dotplot.sh

# Fig 13-16 — per-tissue HOMER bubble plots
Rscript 09_figures/per_tissue_HOMER_plots/homer_kidney_plot.R
Rscript 09_figures/per_tissue_HOMER_plots/homer_lung_plot.R
Rscript 09_figures/per_tissue_HOMER_plots/homer_aorta_plot.R
Rscript 09_figures/per_tissue_HOMER_plots/homer_tcells_plot.R
Rscript 09_figures/per_tissue_HOMER_plots/Kidney_amalgamation.R   # alternative Kidney panel

# Fig 18-21 — see 08_aging_comparison/ (figures generated as part of the overlap pipeline)
```
